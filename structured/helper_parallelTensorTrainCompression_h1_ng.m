function [G] = helper_parallelTensorTrainCompression_h1_ng(r1, A, r2, dims, dims_identity, accur_per_dim)
    ...
    G1 = helper_parallelTensorTrainCompression_h1_ng(r1, U, r, dims(1:d_half), dims_identity(1:d_half), accur_per_dim);
    G2 = helper_parallelTensorTrainCompression_h1_ng(r, S*V', r2, dims(d_half+1:d), dims_identity(d_half+1:d), accur_per_dim);
