function [G INVS] = helper_parallelTensorTrainCompression_h3_gFixedRankRandomizedSVD(r1, A, r2, dims, dims_identity, fixed_rank)
    ...
    %%[U S V] = svd(C, 'econ');
    tic
    [U S V] = randomized_svd(C, fixed_rank);
    toc
    r = findRank(S);
    %%r = min(r, fixed_rank);
