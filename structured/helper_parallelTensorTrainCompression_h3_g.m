function [G INVS] = helper_parallelTensorTrainCompression_h3_g(r1, A, r2, dims, dims_identity, accur)
    ...
    [G1 INVS1] = helper_parallelTensorTrainCompression_h3_g(r1, U*S, r, dims(1:d_half), dims_identity(1:d_half), lhs_next_level_error);
    [G2 INVS2] = helper_parallelTensorTrainCompression_h3_g(r, S*V', r2, dims(d_half+1:d), dims_identity(d_half+1:d), rhs_next_level_error);
